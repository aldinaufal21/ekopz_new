<div class="content-wrapper">
  ...
  <section class="content">
    <div class="box">
      <div class="box-body">
        <form action="<?php echo base_url('admin/neraca/update/'.$neraca->Id_Neraca); ?>" method="post">
          ...
          <div class="form-row">
            <div class="form-group col-md-8">
        			...
        			<input type="text" class="form-control" value="<?php echo $neraca->rincian; ?>" name="rincian" id="rincian" placeholder="Rincian">
        		</div>
          </div>
          <div class="form-row">
            <div class="form-group col-md-8">
        			<label for="tahun">Tahun</label>
        			<input type="text" class="form-control" value="<?php echo $neraca->Tahun; ?>" name="tahun" id="tahun" placeholder="Tahun">
        		</div>
          </div>
          <div class="form-row">
            <div class="form-group col-md-8">
        			<label for="Jumlah">Jumlah</label>
        			<input type="text" class="form-control" value="<?php echo $neraca->Jumlah; ?>" id="jumlah" name="jumlah" placeholder="Jumlah">
        		</div>
            <div class="form-row">
              <div class="form-group col-md-8">
