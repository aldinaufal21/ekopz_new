			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="ftco-nav">
					<ul class="navbar-nav ml-auto">
						<li class="nav-item active"><a href="<?php echo base_url(); ?>landingpage/home" class="nav-link">Home</a></li>
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="dropdown04">
								<a class="dropdown-item" href="<?php echo base_url(); ?>landingpage/store">Shop</a>
						...
						<li class="nav-item"><a href="<?php echo base_url(); ?>landingpage/about" class="nav-link">About Us</a></li>
						<li class="nav-item"><a href="<?php echo base_url(); ?>landingpage/koperasi" class="nav-link">Join Koperasi</a></li>
						<li class="nav-item"><a href="<?php echo base_url(); ?>landingpage/contact" class="nav-link">Contact</a></li>
