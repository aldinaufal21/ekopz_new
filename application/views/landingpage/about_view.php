<div class="hero-wrap hero-bread" style="background-image: url('<?php echo base_url(); ?>assets/landingpage/images/home_1.jpg');">
    ...
    <section class="ftco-section contact-section bg-light">
      <div class="container">
		...
		<section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(<?php echo base_url(); ?>assets/landingpage/images/bg_3.jpg);">
    	<div class="container">
    		<div class="row justify-content-center py-5">
    			<div class="col-md-10">
            <h3 style="margin-left: 360px;">Tentang Kami</h3>
		    		<div class="row" >
		          <div class="col-md-3 d-flex justify-content-center counter-wrap ftco-animate" style="margin-left: auto; margin-right: auto;">
